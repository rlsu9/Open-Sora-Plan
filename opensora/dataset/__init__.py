...
from opensora.dataset.pre_t2v_datasets import PRE_T2V_dataset
...
def getdataset(args):
    ...
    if args.dataset == 't2v':
        return PRE_T2V_dataset(args, transform=transform, temporal_sample=temporal_sample, tokenizer=tokenizer)
